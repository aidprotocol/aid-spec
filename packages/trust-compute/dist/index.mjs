...
var TestSigner = class _TestSigner {
  ...
  static generate() {
    const { generateKeyPairSync, createPrivateKey } = __require("crypto");
  ...
  static fromSeed(seed) {
    const { createPrivateKey, createPublicKey } = __require("crypto");
  ...
  async verify(canonicalBytes, signature, publicKeyMultibase) {
    const { verify, createPublicKey } = __require("crypto");
